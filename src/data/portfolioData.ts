  ...
  vi: [
    {
      ...
      category: "backend",
      role: "Kỹ sư Phần mềm Fullstack (Thực tập sinh)",
      image: "/assets/projects/smart-logistics/desktop.jpg",
      tags: ["Node.js / TypeScript", "PostgreSQL 15 (Prisma ORM)", "Redis 7", "Socket.io", "Genetic Algorithm", "RabbitMQ", "React SPA", "Clean Architecture"],
      architectureHighlights: [
        "Tham gia phát triển CSDL PostgreSQL 15 chuẩn 3NF và tầng Backend (Express.js, TypeScript) theo Clean Architecture & DDD; xây dựng React SPA Dispatcher Dashboard tích hợp radar tracking thời gian thực.",
        "Xây dựng pipeline thuật toán định tuyến 4 giai đoạn thuần TypeScript (DBSCAN → K-Means → GA → Hungarian Algorithm), giảm 58.2% quãng đường vận chuyển cho 500+ đơn hàng/ngày.",
        "Thiết kế đường ống GPS telemetry trên Redis (1.321 tọa độ/giây, P99 < 1ms) và hàng đợi RabbitMQ; tuân thủ nghiêm ngặt quy trình Git branching và PR review.",
      ],
  ...
  en: [
    {
      ...
      tags: ["Node.js / TypeScript", "PostgreSQL 15 (Prisma ORM)", "Redis 7", "Socket.io", "Genetic Algorithm", "RabbitMQ", "React SPA", "Clean Architecture"],
      architectureHighlights: [
        "Participated in developing 3NF normalized PostgreSQL 15 schema and Backend layer (Express.js, TypeScript) following Clean Architecture & DDD; built React SPA Dispatcher Dashboard with real-time radar fleet tracking.",
        "Engineered 4-stage route optimization pipeline in pure TypeScript (DBSCAN → K-Means → GA → Hungarian Algorithm), reducing transit distance by 58.2% for 500+ orders/day.",
        "Designed GPS telemetry pipeline on Redis (1,321 coordinates/sec, P99 < 1ms) with RabbitMQ task queue; strictly adhered to Git branching and PR review standards.",
      ],
