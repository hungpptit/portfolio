...
export const PROJECTS: Record<Language, Project[]> = {
  ...
  en: [
    ...
    },
    {
      id: "movie-ticket-booking",
      title: "Online Movie Ticket Booking System",
      subtitle: "Distributed seat booking microservices with zero double-booking concurrency guarantee",
      description: "Distributed cinema ticket booking platform built on an autonomous Microservices architecture. Eliminates concurrency race conditions when thousands of users contend for the same VIP seat simultaneously using Redis Distributed Locks.",
      category: "backend",
      featured: true,
      branch: "tree/kientruc",
      tags: ["Microservices", "Redis Distributed Lock", "RabbitMQ", "SQL Server", "Express.js", "ZaloPay QR", "React"],
      architectureHighlights: [
        "Autonomous Microservices Architecture: API Gateway, User, Movie, Booking, Payment, and Notification Services.",
        "Redis Distributed Locking (SET NX EX) with auto-expiring TTL ensuring Zero Double-Booking under heavy concurrent traffic.",
        "Asynchronous message streaming with RabbitMQ to decouple booking confirmation from ticket email generation.",
        "Integrated ZaloPay Dynamic QR payment workflow with automated lock release upon payment expiration."
      ],
      metrics: "Zero Double-Booking under High Concurrency",
      githubUrl: "https://github.com/hungpptit/XEMPHIM/tree/kientruc",
      demoUrl: "https://github.com/hungpptit/XEMPHIM/tree/kientruc",
      hasDetailPage: true
    },
    {
      id: "toeic-ai-microservices",
      title: "TOEIC Learning & AI Chatbot Ecosystem",
      subtitle: "Smart exam preparation platform powered by Microservices & AI Chatbot Agent",
      description: "Comprehensive English certification (TOEIC) learning ecosystem featuring an AI Chatbot Assistant. Integrates fine-tuned BERT for user intent classification and Machine Learning algorithms for personalized study pathway recommendations.",
      category: "ai",
      featured: false,
      tags: ["Microservices", "Flutter", "Gemini API", "BERT NLP", "Naïve Bayes", "kNN", "Node.js"],
      architectureHighlights: [
        "Decoupled Microservices: Authentication Service, Quiz Engine Service, and AI Agent Service.",
        "Cross-platform mobile application built with Flutter delivering fluid 60 FPS offline-capable UX.",
        "Integrated Google Gemini AI & fine-tuned BERT to classify intent and provide deep contextual grammar explanations.",
        "Machine Learning algorithms (Naïve Bayes + k-Nearest Neighbors) to diagnose learning gaps and curate dynamic mock exams."
      ],
      metrics: "Adaptive AI-Driven Personalized Learning",
      githubUrl: "https://github.com/hungpptit/chatbot-toeic-flutter/tree/microservice",
      demoUrl: "https://github.com/hungpptit/chatbot-toeic/tree/master",
      hasDetailPage: true
    },
